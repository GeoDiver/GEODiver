...
(function() {
  ...
  GD.setUpValidatorDefaults = function() {
    $.validator.addMethod('geoDb', function (value) { 
        return /^G..\d\d?\d?\d?\d?$/i.test(value); 
